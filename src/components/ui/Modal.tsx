...
import { getWindowLabel, isDesktop } from '@/lib/platform';
...
const defaultClassNames = {
  ...
  base: `border-border backdrop-blur-xl bg-blur blur-bg text-[#a8b0d3] max-h-[90vh] ${isDesktop() && getWindowLabel() !== 'quick-add' ? 'mb-9!' : ''}`,
