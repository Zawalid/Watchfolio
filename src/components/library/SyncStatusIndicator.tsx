...
export function SyncStatusIndicator({
  ...
  if (asDropDownOption) {
    return (
      <button
        className='group flex w-full items-center justify-between gap-3 rounded-xl px-4 py-2 transition-all duration-200 hover:scale-[1.02] hover:bg-white/5'
        onClick={manualSync}
