export const SELECT_CLASSNAMES = {
  ...
  popoverContent: 'text-white/80 bg-white/5 backdrop-blur-md border border-white/5',
...
export const DROPDOWN_CLASSNAMES = {
  base: 'min-w-64',
  content: 'bg-white/5 [&_kbd:first-child]:ml-5 backdrop-blur-md text-white/80 border border-white/5',
};
