...
import { getPersonDetails, getPersonCombinedCredits } from '@/lib/api/TMDB/people';
import { queryKeys } from '@/lib/react-query';
import { calculateKnownForScore, categorizeCredits } from '@/utils/media';
import PersonCategories from '@/components/person-details/PersonCategories';
import PersonCredits from '@/components/person-details/PersonCredits';
import PersonProfile from '@/components/person-details/PersonProfile';
...
export default function Person() {
  ...
  const [personResult, creditsResult] = useQueries({
    queries: [
      { queryKey: queryKeys.person(personId), queryFn: () => getPersonDetails(personId), enabled: !!personId },
      {
        queryKey: [...queryKeys.person(personId), 'combined-credits'],
